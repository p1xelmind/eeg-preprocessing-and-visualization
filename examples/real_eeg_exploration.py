...
from signal_cleaning.visualization import plot_epochs_overview, plot_average_epoch, plot_psd_epochs, plot_topomap, psd_before_after
...
plot_epochs_overview(epochs, 5, 10)
plot_average_epoch(epochs)
plot_psd_epochs(epochs)

evoked = epochs.average()
plot_topomap(evoked)

psd_before_after(raw, raw_copy)